    ...
    <main className="min-h-screen pt-24 pb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 mb-4">
                Find us at various locations around Katy, TX. Check our social media for daily locations 
            ...
            <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-lg transition-shadow">
              ...
              <a 
                href="tel:+1234567890" 
                className="inline-block mt-4 px-6 py-3 bg-desi-orange hover:bg-desi-orange/90 
      ...
      <section className="py-16 bg-desi-black text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <a 
            href="mailto:catering@desiflavors.com" 
            className="inline-block px-8 py-3 bg-desi-orange hover:bg-desi-orange/90 
